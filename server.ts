...
// Most hosting platforms (Liara, Render, Railway, etc.) assign a dynamic
// port via the PORT environment variable and route traffic to it. Reading
// it here (falling back to 3000 for local development) is required for
// the app to work once deployed.
